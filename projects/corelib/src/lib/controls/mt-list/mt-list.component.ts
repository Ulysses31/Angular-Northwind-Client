...
import { MtListItem } from '../../models/mt-list-item';
import { MtListSection } from '../../models/mt-list-section';
...
@Component({
  ...
  template: `
      ...
      <mat-list role="list" [disabled]="disabled">
        ...
        <ng-container *ngIf="isSection">
          <div *ngFor="let section of itemSection; let i = index">
            ...
            <mat-divider
              *ngIf="i < itemSection.length - 1 && itemSection.length > 1"
            ></mat-divider>
          </div>
        </ng-container>
      </mat-list>
    ...
    <ng-container *ngIf="checkboxSelection">
      ...
      >
        <ng-container *ngIf="!isSection">
          <mat-list-option *ngFor="let item of itemList" [value]="item.value">
            {{ item.label }}
          </mat-list-option>
        </ng-container>
  ...
  `,
  styleUrls: ['./mt-list.component.css'],
})
